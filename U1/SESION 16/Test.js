...
function siguientePregunta(){
    document.getElementById("pregunta").innerHTML=preguntas[i]; /*estamos accediendo a las preguntas de arriba para los botones*/
...
function mostrarResultado(){
    ...
    document.getElementsByClassName("preguntas_alternativas")[0].innerHTML="";
}
